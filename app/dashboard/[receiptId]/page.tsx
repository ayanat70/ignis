...
export default function ReceiptDashboardPage() {
  ...
  // Client-side adjusted hours state for interactive simulator
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        const estList: ApplianceEstimate[] = breakdown.estimates || [];
        ...
        > = {};
        const initSimHours: Record<string, number> = {};

        apps.forEach((app) => {
          const existing = estList.find((e) => e.applianceId === app.id);
          inputs[app.id] = {
        ...
        estList.forEach((e) => {
          initSimHours[e.applianceId] = e.hoursPerDay;
        });
        setSimulatedHours(initSimHours);
  ...
  // Client-side Live Recalculation for Simulator
  ...
  // Reset simulator to original baseline hours
    ...
    <div className="animate-in fade-in space-y-8 duration-300">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-0.5 text-sm text-slate-400">
            ...
            {formatTenge(receipt.totalAmount)})
          </p>
        </div>
      ...
      {hasCalculation && (
        <>
                      ...
                      <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                        ...
                        <div className="shrink-0 text-left sm:text-right">
                          ...
                          <p className="font-mono text-xs font-semibold text-amber-400">
                            {formatTenge(approxCost, "~")} ({percentOfTotal}%)
                          </p>
                        </div>
                      </div>
          ...
          {/* Section 3: Integrated Live Savings Simulator */}
          <div className="space-y-6 pt-4 border-t border-slate-800/80">
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              <div>
                <h2 className="flex items-center gap-2.5 text-2xl font-bold tracking-tight text-white">
                  ...
                  Симулятор экономии «Что если»
                </h2>
                <p className="mt-1 text-sm text-slate-400">
                  Меняйте время работы приборов и наблюдайте мгновенный пересчёт экономии без обращения к серверу
                </p>
              </div>
            ...
            {/* Comparison Summary Cards: Было vs Стало vs Экономия */}
              ...
              <Card className="border-slate-800 bg-slate-900/60 p-5">
                ...
                <div className="mt-2 space-y-1">
                  ...
                  <p className="font-mono text-sm text-slate-400">
                    {formatTenge(simulationResults.baselineAmount)} (по квитанции)
                  </p>
                </div>
              </Card>
              ...
              <Card className="border-orange-500/30 bg-orange-950/20 p-5">
                ...
                <div className="mt-2 space-y-1">
                  ...
                  <p className="font-mono text-sm text-orange-400/80">
                    {formatTenge(simulationResults.simulatedAmount, "~")} (новый прогноз)
                  </p>
                </div>
              </Card>
              ...
              >
                ...
                <div className="mt-2 space-y-1">
                  ...
                  >
                    ...
                    {formatTenge(Math.abs(simulationResults.savedMoney))}
                  </p>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  выключение кондиционера на ночь или сокращение работы обогревателя)
                </CardDescription>
              </CardHeader>
                          ...
                          <div className="shrink-0 text-right">
                            ...
                            {item.diffMoney !== 0 && (
                              ...
                              >
                                ...
                                {formatTenge(Math.abs(item.diffMoney))}
                              </p>
                            )}
                          </div>
                        </div>
